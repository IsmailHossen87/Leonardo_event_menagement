...
const toggleUserNotification = catchAsync(async (req, res) => {
     const { userId } = req.params;

     const result = await UserService.toggleUserNotification(userId, req.body);

     sendResponse(res, {
          success: true,
          statusCode: StatusCodes.OK,
          message: 'User notification toggled successfully',
          data: result,
     });
});
...
const approveHostRequest = catchAsync(async (req, res) => {
     const result = await UserService.approveHostRequest(req.user as any);
     sendResponse(res, {
          success: true,
          statusCode: StatusCodes.OK,
...
const deleteMyAccount = catchAsync(async (req, res) => {
     const result = await UserService.deleteMyAccount(req.user as any);
     sendResponse(res, {
          success: true,
          statusCode: StatusCodes.OK,
