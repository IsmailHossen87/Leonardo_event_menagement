...
const fileUploadHandler = () => {
          ...
          destination: (req, file, cb) => {
               ...
               switch (file.fieldname) {
                    ...
                    case 'document':
                         ...
                         break;
                    case 'gallary':
                         uploadDir = path.join(baseUploadDir, 'gallary');
                         break;
                    default:
     ...
     // File filter - FIXED THE TYPO: 'images/png' to 'image/png'
     const filterFilter = (req: Request, file: any, cb: FileFilterCallback) => {
          if (
               ...
               if (
                    file.mimetype === 'image/png' ||  // Fixed typo here
               ...
               if (
                    ...
                    cb(new AppError(StatusCodes.BAD_REQUEST, 'Gallery only supports images (.jpeg, .png, .jpg, .webp) and videos (.mp4, .webm, .mov, .avi, .mpeg)'));
               }
